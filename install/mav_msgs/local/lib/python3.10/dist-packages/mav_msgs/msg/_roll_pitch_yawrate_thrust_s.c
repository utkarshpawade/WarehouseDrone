...
bool mav_msgs__msg__roll_pitch_yawrate_thrust__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mav_msgs.msg._roll_pitch_yawrate_thrust.RollPitchYawrateThrust", full_classname_dest, 62) == 0);
  }
  mav_msgs__msg__RollPitchYawrateThrust * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RollPitchYawrateThrust */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mav_msgs.msg._roll_pitch_yawrate_thrust");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RollPitchYawrateThrust");
