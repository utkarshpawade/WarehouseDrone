...
#include "mav_state_machine_msgs/srv/detail/run_task_service__type_support.h"
...
static const _RunTaskService_Request_type_support_symbol_names_t _RunTaskService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_state_machine_msgs, srv, RunTaskService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_state_machine_msgs, srv, RunTaskService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mav_state_machine_msgs, srv, RunTaskService_Request)() {
  return &::mav_state_machine_msgs::srv::rosidl_typesupport_c::RunTaskService_Request_message_type_support_handle;
}
...
static const _RunTaskService_Response_type_support_symbol_names_t _RunTaskService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_state_machine_msgs, srv, RunTaskService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_state_machine_msgs, srv, RunTaskService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mav_state_machine_msgs, srv, RunTaskService_Response)() {
  return &::mav_state_machine_msgs::srv::rosidl_typesupport_c::RunTaskService_Response_message_type_support_handle;
}
...
static const _RunTaskService_type_support_symbol_names_t _RunTaskService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mav_state_machine_msgs, srv, RunTaskService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mav_state_machine_msgs, srv, RunTaskService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mav_state_machine_msgs, srv, RunTaskService)() {
  return &::mav_state_machine_msgs::srv::rosidl_typesupport_c::RunTaskService_service_type_support_handle;
}
