...
static const _PIDError_type_support_symbol_names_t _PIDError_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pid_msg, msg, PIDError)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pid_msg, msg, PIDError)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pid_msg, msg, PIDError)() {
  return &::pid_msg::msg::rosidl_typesupport_c::PIDError_message_type_support_handle;
}
