...
bool mav_msgs__msg__gps_waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mav_msgs.msg._gps_waypoint.GpsWaypoint", full_classname_dest, 38) == 0);
  }
  mav_msgs__msg__GpsWaypoint * ros_message = _ros_message;
  {  // header
...
PyObject * mav_msgs__msg__gps_waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mav_msgs.msg._gps_waypoint");
