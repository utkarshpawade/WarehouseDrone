...
bool mav_msgs__msg__rate_thrust__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mav_msgs.msg._rate_thrust.RateThrust", full_classname_dest, 36) == 0);
  }
  mav_msgs__msg__RateThrust * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RateThrust */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mav_msgs.msg._rate_thrust");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RateThrust");
