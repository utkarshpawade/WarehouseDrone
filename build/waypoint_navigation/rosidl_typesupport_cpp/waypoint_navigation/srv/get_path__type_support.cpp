...
static const _GetPath_Request_type_support_symbol_names_t _GetPath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, waypoint_navigation, srv, GetPath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, waypoint_navigation, srv, GetPath_Request)),
  }
};
...
{
  return &::waypoint_navigation::srv::rosidl_typesupport_cpp::GetPath_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, waypoint_navigation, srv, GetPath_Request)() {
  return get_message_type_support_handle<waypoint_navigation::srv::GetPath_Request>();
}
...
static const _GetPath_Response_type_support_symbol_names_t _GetPath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, waypoint_navigation, srv, GetPath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, waypoint_navigation, srv, GetPath_Response)),
  }
};
...
{
  return &::waypoint_navigation::srv::rosidl_typesupport_cpp::GetPath_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, waypoint_navigation, srv, GetPath_Response)() {
  return get_message_type_support_handle<waypoint_navigation::srv::GetPath_Response>();
}
...
static const _GetPath_type_support_symbol_names_t _GetPath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, waypoint_navigation, srv, GetPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, waypoint_navigation, srv, GetPath)),
  }
};
...
{
  return &::waypoint_navigation::srv::rosidl_typesupport_cpp::GetPath_service_type_support_handle;
}
