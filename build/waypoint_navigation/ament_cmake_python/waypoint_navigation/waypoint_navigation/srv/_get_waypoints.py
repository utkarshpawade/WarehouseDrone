...
class Metaclass_GetWaypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from waypoint_navigation.srv import _get_waypoints
...
class GetWaypoints(metaclass=Metaclass_GetWaypoints):
    from waypoint_navigation.srv._get_waypoints import GetWaypoints_Request as Request
    from waypoint_navigation.srv._get_waypoints import GetWaypoints_Response as Response
