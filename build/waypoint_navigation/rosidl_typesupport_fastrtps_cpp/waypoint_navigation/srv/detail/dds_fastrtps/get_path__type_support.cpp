...
#include "waypoint_navigation/srv/detail/get_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const waypoint_navigation::srv::GetPath_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  waypoint_navigation::srv::GetPath_Request & ros_message)
{
  // Member: start_point
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = waypoint_navigation::srv::GetPath_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const waypoint_navigation::srv::GetPath_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<waypoint_navigation::srv::GetPath_Request *>(
    untyped_ros_message);
...
{
  return &waypoint_navigation::srv::typesupport_fastrtps_cpp::_GetPath_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, waypoint_navigation, srv, GetPath_Request)() {
  return &waypoint_navigation::srv::typesupport_fastrtps_cpp::_GetPath_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_waypoint_navigation
cdr_serialize(
  const waypoint_navigation::srv::GetPath_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: path
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  waypoint_navigation::srv::GetPath_Response & ros_message)
{
  // Member: path
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = waypoint_navigation::srv::GetPath_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const waypoint_navigation::srv::GetPath_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<waypoint_navigation::srv::GetPath_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &waypoint_navigation::srv::typesupport_fastrtps_cpp::_GetPath_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, waypoint_navigation, srv, GetPath_Response)() {
  return &waypoint_navigation::srv::typesupport_fastrtps_cpp::_GetPath_Response__handle;
}
...
{
  return &waypoint_navigation::srv::typesupport_fastrtps_cpp::_GetPath__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, waypoint_navigation, srv, GetPath)() {
  return &waypoint_navigation::srv::typesupport_fastrtps_cpp::_GetPath__handle;
}
