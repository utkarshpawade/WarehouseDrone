...
static const _SwiftMsgs_type_support_symbol_names_t _SwiftMsgs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, swift_msgs, msg, SwiftMsgs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, swift_msgs, msg, SwiftMsgs)),
  }
};
...
{
  return &::swift_msgs::msg::rosidl_typesupport_cpp::SwiftMsgs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, swift_msgs, msg, SwiftMsgs)() {
  return get_message_type_support_handle<swift_msgs::msg::SwiftMsgs>();
}
