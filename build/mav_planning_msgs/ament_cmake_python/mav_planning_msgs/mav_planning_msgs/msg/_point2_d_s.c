...
bool mav_planning_msgs__msg__point2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mav_planning_msgs.msg._point2_d.Point2D", full_classname_dest, 39) == 0);
  }
  mav_planning_msgs__msg__Point2D * ros_message = _ros_message;
  {  // x
...
PyObject * mav_planning_msgs__msg__point2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mav_planning_msgs.msg._point2_d");
